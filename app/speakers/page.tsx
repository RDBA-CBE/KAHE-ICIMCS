              ...
              >
                <div className='p-4'>
                  <div className='flex justify-center mb-6 '>
                    <div className='w-68 h-68 rounded-xl bg-gradient-to-br from-primary via-purple-500 to-cyan-500 p-1'>
                      <div className='w-full h-full rounded-lg bg-background overflow-hidden'>
                        <img
                          src={getSpeakerImage(index)}
                          alt={speaker.name}
                          className='w-full h-full object-cover object-top p-2 rounded-lg'
