...
export function SponsorsSection() {
  ...
  const acsJournals = [
    { name: 'ACS Applied Nano Materials', image: '/sponsors/Sponsor-1.jpg' },
    { name: 'ACS Applied Energy Materials', image: '/sponsors/Sponsor-2.jpg' },
    { name: 'ACS Materials', image: '/sponsors/Sponsor-3.jpg' },
  ];
              ...
              <div className='flex items-start gap-4'>
                ...
                <div>
                  <p className='text-gray-700 leading-relaxed mb-4'>
                    Best 5 presentations certificates from the American Chemical
                    Society (ACS) - ACS Applied Nano Materials, ACS Omega, ACS
                    Sustainable Resource Management, ACS Materials Au, ACS
                    Applied Energy Materials.
                  </p>
                 
                  <p className='text-lg font-bold text-gray-900 text-left'>
                    Best presenters will receive the ACS certificates and the
                    cash prize of{' '}
                    <span className='text-gray-700 bg-yellow-100 px-2 py-1 rounded'>
                      INR 3000
                    </span>{' '}
                    each.
                  </p>
                  <p className='text-lg font-bold text-gray-900 text-center'>
                     RSC one year online journal subscription.
                  </p>
                </div>
              </div>
            </div>
